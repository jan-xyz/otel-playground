...
require (
	...
	github.com/uptrace/opentelemetry-go-extra/otellogrus v0.1.17 // indirect
	github.com/uptrace/opentelemetry-go-extra/otelutil v0.1.17 // indirect
	go.opencensus.io v0.24.0 // indirect
	go.opentelemetry.io/collector v0.64.0 // indirect
	go.opentelemetry.io/collector/pdata v0.64.0 // indirect
	go.opentelemetry.io/collector/semconv v0.64.0 // indirect
	go.opentelemetry.io/contrib/instrumentation/github.com/aws/aws-lambda-go/otellambda v0.36.4 // indirect
